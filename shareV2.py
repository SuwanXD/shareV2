...
def login():
	...
	try:
		...
		random_kata = random.choice(["acc dong suhu","Rasanya aku begitu lelah untuk terus berbisik memanggil namamu @[100036939615544:] 😢","Ijin pake scriptnya bang","suhuku nih bos @[100036939615544:] senggol dong😎🤙","suwan ganteng 🤪","I Love You @[100036939615544:]","Semangat Bang😎"])
